    ...
    <div className="flex flex-col bg-gray-300 dark:bg-gray-700 rounded w-full h-full">
      ...
      <Flex className="w-full h-full pb-1 justify-around max-h-24">
        <Flex className="info flex-col text-center text-white justify-end">
          <Title className="text-black dark:text-white text-base md:text-lg">{title}</Title>
          <div className="flex gap-1 md:gap-4">
            <Image alt="image" src={urlSkill1} className="bg-gray-900 dark:bg-white rounded-lg h-6 w-6 p-[.2rem]" />
            <Image alt="image" src={urlSkill2} className="bg-gray-900 dark:bg-white rounded-lg h-6 w-6 p-1" />
            <Image alt="image" src={urlSkill3} className="bg-gray-900 dark:bg-white rounded-lg h-6 w-6 p-1" />
            <Image alt="image" src={urlSkill4} className="bg-gray-900 dark:bg-white rounded-lg h-6 w-6 p-1" />
          </div>
        </Flex>
        <div className="buttons flex flex-col justify-end">
          <Anchor className="hidden no-underline" href={urlProject} target="_blank">
